...
// Define the insight types for better type safety
type PricePositioningStatus = 'higher' | 'lower' | 'competitive';
type TrendDirection = 'up' | 'down' | 'stable';
type TrendForecast = 'increase' | 'decrease' | 'stable';
type PricingSensitivity = 'high' | 'medium' | 'low';
...
export function CompetitorAiInsights() {
  ...
  const generateAiInsights = async () => {
    ...
    try {
      ...
      const mockInsights: CompetitorInsights = {
        pricing: {
          pricePositioning: { 
            status: ['higher', 'lower', 'competitive'][Math.floor(Math.random() * 3)] as PricePositioningStatus, 
        ...
        trends: {
          direction: ['up', 'down', 'stable'][Math.floor(Math.random() * 3)] as TrendDirection,
          percentageChange: +(Math.random() * 8 + 1).toFixed(1),
          forecast: ['increase', 'decrease', 'stable'][Math.floor(Math.random() * 3)] as TrendForecast,
          categories: [
        ...
        strategy: {
          ...
          pricingSensitivity: ['high', 'medium', 'low'][Math.floor(Math.random() * 3)] as PricingSensitivity
        }
      };
