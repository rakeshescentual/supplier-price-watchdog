...
import { DocumentationTabContent } from "./DocumentationTabContent";
...
import { DocumentationSearchResults } from "./DocumentationSearchResults";
      ...
      {Object.keys(bookmarks).map(tabKey => (
        <TabsContent key={tabKey} value={tabKey} className="mt-6">
          <DocumentationTabContent 
            ...
            onQuickRefClose={onQuickRefClose}
            onBookmark={toggleBookmark}
            onDownload={handleDownload}
            additionalContent={tabKey === "technical" ? getTechnicalAdditionalContent() : 
                            tabKey === "gadget" ? getGadgetAdditionalContent() : undefined}
...
// Helper functions
function getTabDisplayName(tabKey: string): string {
...
function getDocumentationContent(tabKey: string): string {
...
function getTechnicalAdditionalContent() {
  return (
    <>
...
function getGadgetAdditionalContent() {
  return (
    <>
